...
def get_rap_synth(cfg, columns, train_encoded, eps, columns_domain):
    ...
    synth_file_name = DATA_DIR + f"experiment_artifacts/rap_synth_eps{'{0:.2f}'.format(eps)}_{cfg.data_name}"
    results_file_name = DATA_DIR + f"experiment_artifacts/rap_synth_results_{cfg.data_name}"
